...
import { participateEventSocio } from "../Events_TSG/actions";
...
const Example = (props) => {
	...
	const socialEventsData = useSelector((state) => state.socialEvents.social_events);
	...
	return (
						...
						<Col sm="9">
							<CardBody>
								...
								<p>
									...
									{new Date(event.eventStartTime).getFullYear()} | {new Date(event.eventEndTime).getDate()}-
                      ...
                      onClick={()=>{
                        ...
                        setImage(event.images)
											...
											style={{
												...
												textDecoration: "none",color:"#727dbd",fontWeight:"bolder",cursor:"pointer"
											}}
										>
											Read More
										</a>
      ...
      <Modal isOpen={isExtended} toggle={()=>{
        setNameEvent(null)
        setDescription(null)
        setEndDate(null)
        setOrganizer(null)
          ...
          setModalOpen(false)
			...
			{userType !== "student" ? (
          	...
          	<h2 style={{ textAlign: "left", fontWeight: "bolder" }}>
					...
					{socialParticipatedEvents === undefined ? (
						<div>Empty</div>
					) : (
						<Carousel responsive={responsive}>
							{socialParticipatedEvents.map((participatedEvent) => (
								<div style={{ height: "40em" }}>
									<Card style={{ margin: "0 1%", border: "none" }}>
										<div
											style={{ height: "25em", width: "25em", margin: "auto" }}
